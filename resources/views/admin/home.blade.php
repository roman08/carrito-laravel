...
@section('content')
    ...
    <div class="container text-center">
        ...
        <h2>Bienvenido(a) {{ Auth::user()->name }} al Panel de administración de tu tienda en línea.</h2><hr>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="panel">
                    ...
                    <a href="{{ route('admin.categories.index') }}" class="btn btn-warning btn-block btn-home-admin">CATEGORÍAS</a>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="panel">
                    ...
                    <a href="{{ route('admin.products.index') }}" class="btn btn-warning btn-block btn-home-admin">PRODUCTOS</a>
                </div>
            </div>
